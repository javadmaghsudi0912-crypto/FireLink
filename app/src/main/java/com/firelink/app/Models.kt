...
data class TeamInfo(val name:String="", val code:String="", val ownerUid:String="", val createdAt:Long=0L, val active:Boolean=true)
data class TeamSummary(val teamId:String="", val name:String="", val code:String="", val role:String="member")
